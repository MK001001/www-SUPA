...
if ($bFormSubmitted === true){
	...
	if (strlen($email1) < 5){
		$feedback .= "<ul><li>Your email is not long enough</li></ul>";
	}
	if (false === validAge()){
		$feedback .= "<ul><li>You must be at least 18 years old</li></ul>";
	}
	if (strlen($password) < 5){
		$feedback .= "<ul><li>Password too short</li></ul>";
	}
				...
				<div class="row col-12 m-2">
					...
					<div class="col-12 border p-2">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="captchaAns" value="<?php echo $recaptchaData['sum'];?>"/>
						</div>
					</div>
